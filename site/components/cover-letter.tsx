...
const COVER_LETTERS: CoverLetterSample[] = [
  {
    ...
    match: 92,
    letter:
      'Видел вакансию Product Designer в Yandex Eats. У вас в требованиях работа с дизайн-системой и B2C-флоу: 4 года в продуктовом дизайне, последний кейс: переработка чекаута в food-delivery, конверсия выросла на 11%. Готов созвониться обсудить портфолио и задачи команды. Зарплатные ожидания: от 320 000 ₽.',
  },
  {
    ...
    match: 88,
    letter:
      'Здравствуйте. По вакансии шеф-повара горячего цеха: 5 лет на горячке в авторских ресторанах СПб, последние два года су-шеф в проекте на 120 посадок. Знаю ХАССП, веду бригаду 6 человек, выводил два сезонных меню. Готов приехать на стажировку. Зарплатные ожидания: 140 000 ₽.',
  },
  {
    ...
    match: 84,
    letter:
      'По вакансии менеджера B2B в СтройДвор: 2 года в активных продажах стройматериалов, средний чек 380 000 ₽, план по новым клиентам делал 11 месяцев из 12. Работаю в amoCRM, веду холодную базу через скрипты. Готов к собеседованию на этой неделе. Зарплатные ожидания: 80 000 ₽ + процент.',
  },
];
...
function TrapCard({ icon, title, text }: { icon: React.ReactNode; title: string; text: string }) {
  return (
    <div
      style={{
        background: '#FEF3C7',
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: 13.5, color: '#78350F', lineHeight: 1.45 }}>{text}</div>
      </div>
    </div>
  );
}
